  ...
  return (
    <div className='relative mt-20 border-b border-neutral-800 min-h-[800px]'>
      <div className='text-center'>
        <span className="bg-neutral-900 text-blue-500 rounded-full h-6 text-lg font-medium px-2 py-1 uppercase">Services</span>
        <h2 className='text-3xl sm:text-5xl lg:text-6xl mt-10 lg:mt-20 tracking wide'>Easily build
          {"  "}
          <span className='bg-gradient-to-r from-blue-500 to-blue-500 text-transparent bg-clip-text'>your code</span>
        </h2>
      </div>
